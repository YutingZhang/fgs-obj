...
LayerParameter_LayerType UpgradeV0LayerType(const string& type) {
  ...
  } else if (type == "nan2zero") {
    return LayerParameter_LayerType_NAN2ZERO;
  } else if (type == "l2svm_loss") {
	    return LayerParameter_LayerType_L2SVM_LOSS;
  } else if (type == "orderkeeping_l2svm_loss") {
	    return LayerParameter_LayerType_ORDER_L2SVM_LOSS;
  } else {
